...
# args.MODEL_NAME = '/fsx/BlinkDL/HF-MODEL/rwkv-4-pile-14b/RWKV-4-Pile-14B-20230108-5170.pth'
# args.n_layer = 40
# args.n_embd = 5120
# args.ctx_len = 1024

# args.MODEL_NAME = '/fsx/BlinkDL/HF-MODEL/rwkv-4-pile-7b/RWKV-4-Pile-7B-20221115-8047.pth'
# args.n_layer = 32
# args.n_embd = 4096
# args.ctx_len = 1024

args.MODEL_NAME = '/fsx/BlinkDL/HF-MODEL/rwkv-4-pile-3b/RWKV-4-Pile-3B-20221008-8023.pth'
args.n_layer = 32
args.n_embd = 2560
args.ctx_len = 1024
...
'''
    ...
    args.MODEL_NAME = '/data/nlp/pre_models/torch/rwkv_gf/rwkv-4-raven-3b-v12/RWKV-4-Raven-3B-v12-Eng49%-Chn49%-Jpn1%-Other1%-20230527-ctx4096.pth'
    args.n_layer = 32
    # args.n_embd = 4096
    args.ctx_len = 4096
